...
class LayoutLMv3Trainer:
    ...
    def _initialize_model(self):
        """Initialize LayoutLMv3 model with optional LoRA"""
    ...
    def _initialize_trainer(self):
        ...
        args = TrainingArguments(
            ...
            overwrite_output_dir=self.training_args.get("overwrite_output_dir", True),
            num_train_epochs=self.training_args.get("num_train_epochs", 50),
            ...
            logging_dir=self.training_args.get("logging_dir", "./outputs/logs"),
            ...
            metric_for_best_model=self.training_args.get("metric_for_best_model", "eval_loss"),
            greater_is_better=self.training_args.get("greater_is_better", False),
            seed=self.training_args.get("seed", 42),
            fp16=self.training_args.get("fp16", True),
            ...
            save_strategy="steps",
            report_to="wandb" if self.training_args.get("use_wandb", False) else "none",
        )
